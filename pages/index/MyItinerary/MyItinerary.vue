    ...
    <div class="itinerary-list">
      <div v-for="itinerary in itinerarys" :key="itinerary.id" class="itinerary-card">
        <div class="itinerary-header">
          <span class="vehicle-type" v-if="itinerary.status!=1&&itinerary.status!=4">{{ itinerary.vehicleType }}-{{ itinerary.plate }}</span>
        ...
        <div class="itinerary-footer">
          <button class="delete-button" v-if="itinerary.status==3||itinerary.status==4" @click="delItinerary(itinerary.id)">删除行程</button>
          <button class="button" v-if="itinerary.status==3">开发票</button>
          <button class="button" v-if="itinerary.status==2||itinerary.status==5" @click="toChatPage(itinerary.id)">联系司机</button>
          <button class="again-button" v-if="itinerary.status==3">再来一单</button>
          <button class="button" v-if="itinerary.status==3">投诉</button>
