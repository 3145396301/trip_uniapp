<template>
<uni-shadow-root class="captcha-rotate-index"><view class="tianai-captcha-rotate">
    <view class="tip">
...
global['__wxRoute'] = 'captcha/rotate/index'
    ...
    touchmove(e) {
      ...
      if (moveX > 0 && moveX < this.data.endX) {
        this.setData({
          ...
          rotateDeg: (moveX / (this.data.endX / 360))
        })
      }
    },
    touchend(e) {
...
export default global['__wxComponents']['captcha/rotate/index']
</script>
<style platform="mp-weixin">
/* components/captcha/slider/index.css */
 .tianai-captcha-rotate {
  z-index: 999;
  position: absolute;
  left: 0;
  top: 0;
...
.tianai-captcha-rotate .slider-tip {
  margin-bottom: 5px;
  font-weight: bold;
  font-size: 15px;
  line-height: normal;
...
.tianai-captcha-rotate .tips.tips-error {
  background-color: #FF5D39;
}
.tianai-captcha-rotate .tips.tips-success {
  background-color: #39C522;
}
.tianai-captcha-rotate .tips.tips-on {
  bottom: 0;
}

.tianai-captcha-rotate .move-track-font {
  font-size: 15px;
}

.tianai-captcha-rotate .content {
  width: 100%;
  height: 180px;
  position: relative;
  overflow: hidden;
...
.tianai-captcha-rotate .content .bg-img-div{
  width: 100%;
  height: 100%;
  position: absolute;
  transform: translate(0px, 0px);
}
.tianai-captcha-rotate .content .bg-img-div .bg-img {
  height: 100%;
  width: 100%;
  border-radius: 5px;
}
.tianai-captcha-rotate .content .bg-img-div .bg-div {
  position: absolute;
  left: 0;
  top: 0;
  width: 100%;
...
.tianai-captcha-rotate .content .bg-img-div .bg-div .bg-div-slice {
  position: absolute;
}

.tianai-captcha-rotate .content .rotate-img-div {
  height: 100%;
  text-align: center;
}

.tianai-captcha-rotate .content .rotate-img-div .rotate-move-img {
  height: 100%;
  width: 100px;
...
.tianai-captcha-rotate .slider-move {
  line-height: 38px;
  font-size: 14px;
  text-align: center;
  white-space: nowrap;
...
.tianai-captcha-rotate .slider-move .slider-move-track {
  position: relative;
  height: 32px;
  line-height: 32px;
  text-align: center;
...
.tianai-captcha-rotate .slider-move .slider-move-track .slider-move-track-mask {
  border-color: rgb(2, 152, 248);
  background-color: rgb(137, 210, 255);
  height: 100%;
}

.tianai-captcha-rotate .slider-move .slider-move-track .slider-move-btn {
