<template>
<uni-shadow-root class="captcha-rotate_degree-index"><view class="tianai-captcha-rotate-degree">
  <view class="tip">
  ...
  <view class="content">
    ...
    <view class="bg-img-div">
      <image @load="onBgImageLoad" :style="'transform:rotate('+(rorateDeg)+'deg)'" class="bg-img" :src="captchaData.backgroundImage"></image>
...
global['__wxRoute'] = 'captcha/rotate_degree/index'
...
export default global['__wxComponents']['captcha/rotate_degree/index']
</script>
<style platform="mp-weixin">
/* components/captcha/slider/index.css */
.tianai-captcha-rotate-degree {
  z-index: 999;
  position: absolute;
  left: 0;
  top: 0;
...
.tianai-captcha-rotate-degree .slider-tip {
  margin-bottom: 5px;
  font-weight: bold;
  font-size: 15px;
  line-height: normal;
...
.tianai-captcha-rotate-degree .tips {
  height: 25px;
  width: 100%;
  position: absolute;
  bottom: -25px;
...
.tianai-captcha-rotate-degree .tips.tips-error {
  background-color: #FF5D39;
}

.tianai-captcha-rotate-degree .tips.tips-success {
  background-color: #39C522;
}

.tianai-captcha-rotate-degree .tips.tips-on {
  bottom: 0;
}

.tianai-captcha-rotate-degree .move-track-font {
  font-size: 15px;
}

.tianai-captcha-rotate-degree .content {
  width: 100%;
  height: 180px;
  position: relative;
  overflow: hidden;
...
.tianai-captcha-rotate-degree .content .bg-img-div {
  width: 100%;
  height: 100%;
  position: absolute;
...
.tianai-captcha-rotate-degree .content .mask {
  height: 182px;
  width: 182px;
  position: absolute;
...
.tianai-captcha-rotate-degree .content .bg-img-div .bg-img {
  height: 100%;
  width: 180px;
  border-radius: 50%;
}

.tianai-captcha-rotate-degree .content .bg-img-div .bg-div {
    position: absolute;
    top: 0;
    width: 180px;
    height: 180px;
...
.tianai-captcha-rotate-degree .content .bg-img-div .bg-div .bg-div-slice {
  position: absolute;
}

.tianai-captcha-rotate-degree .content .slider-img-div {
  height: 100%;
  position: absolute;
  transform: translate(0px, 0px);
  width: 55px;
...
.tianai-captcha-rotate-degree .content .slider-img-div .slider-move-img {
  height: 100%;
  width: 100%;
}

.tianai-captcha-rotate-degree .slider-move {
  line-height: 38px;
  font-size: 14px;
  text-align: center;
  white-space: nowrap;
...
.tianai-captcha-rotate-degree .slider-move .slider-move-track {
  position: relative;
  height: 32px;
  line-height: 32px;
  text-align: center;
...
.tianai-captcha-rotate-degree .slider-move .slider-move-track .slider-move-track-mask {
  border-color: rgb(2, 152, 248);
  background-color: rgb(137, 210, 255);
  height: 100%;
}

.tianai-captcha-rotate-degree .slider-move .slider-move-track .slider-move-btn {
