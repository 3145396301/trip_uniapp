<template>
<uni-shadow-root class="captcha-concat-index"><view class="tianai-captcha-concat">
    <view class="tip">
...
global['__wxRoute'] = 'captcha/concat/index'
...
export default global['__wxComponents']['captcha/concat/index']
</script>
<style platform="mp-weixin">
/* components/captcha/slider/index.css */
 .tianai-captcha-concat {
  z-index: 999;
  position: absolute;
  left: 0;
  top: 0;
...
.tianai-captcha-concat .concat-bg-img{
  width: 100%;
  height: 100%;
  position: absolute;
...
.tianai-captcha-concat .slider-tip {
  margin-bottom: 5px;
  font-weight: bold;
  font-size: 15px;
  line-height: normal;
...
.tianai-captcha-concat .tips.tips-error {
  background-color: #FF5D39;
}
.tianai-captcha-concat .tips.tips-success {
  background-color: #39C522;
}
.tianai-captcha-concat .tips.tips-on {
  bottom: 0;
}

.tianai-captcha-concat .move-track-font {
  font-size: 15px;
}

.tianai-captcha-concat .content {
  width: 100%;
  height: 180px;
  position: relative;
  overflow: hidden;
...
.tianai-captcha-concat .content .bg-img-div{
  width: 100%;
  height: 100%;
  position: absolute;
  transform: translate(0px, 0px);
}
.tianai-captcha-concat .content .bg-img-div .bg-img {
  height: 100%;
  width: 100%;
  border-radius: 5px;
}
.tianai-captcha-concat .content .bg-img-div .bg-div {
  position: absolute;
  left: 0;
  top: 0;
  width: 100%;
...
.tianai-captcha-concat .content .bg-img-div .bg-div .bg-div-slice {
  position: absolute;
}

.tianai-captcha-concat .content .slider-img-div {
  height: 100%;
  position: absolute;
  transform: translate(0px, 0px);
  width: 55px;
...
.tianai-captcha-concat .content .slider-img-div .slider-move-img {
  height: 100%;
  width: 100%;
}

.tianai-captcha-concat .slider-move {
  line-height: 38px;
  font-size: 14px;
  text-align: center;
  white-space: nowrap;
...
.tianai-captcha-concat .slider-move .slider-move-track {
  position: relative;
  height: 32px;
  line-height: 32px;
  text-align: center;
...
.tianai-captcha-concat .slider-move .slider-move-track .slider-move-track-mask {
  border-color: rgb(2, 152, 248);
  background-color: rgb(137, 210, 255);
  height: 100%;
}

.tianai-captcha-concat .slider-move .slider-move-track .slider-move-btn {
